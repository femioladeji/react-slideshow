  ...
  _createClass(Zoom, [{
    ...
    value: function addResizeListener() {
      ...
      window.addEventListener('resize', function () {
        _this3.width = document.querySelector('.react-slideshow-zoom-wrapper').clientWidth;
        _this3.height = _this3.divsContainer.children[0].clientHeight;
        _this3.divsContainer.style.height = _this3.height + 'px';
        _this3.applyStyle();
      });
    }
  }, {
    ...
    value: function applyStyle() {
      ...
      this.divRefs.forEach(function (eachDiv, index) {
        if (eachDiv) {
          eachDiv.style.width = _this4.width + 'px';
        }
      });
    }
  }, {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { className: 'nav', onClick: function onClick() {
                return _this5.zoomTo(index === 0 ? children.length - 1 : index - 1);
              } },
            ' ',
            '<',
            ' '
          ...
          _react2.default.createElement(
            'div',
            { className: 'nav', onClick: function onClick() {
                return _this5.zoomTo((index + 1) % children.length);
              } },
            ' ',
            '>',
            ' '
    ...
    value: function zoomTo(newIndex) {
      ...
      var tween = new TWEEN.Tween(value).to({ opacity: 1, scale: scale }, this.props.transitionDuration).onUpdate(function (value) {
        ...
        _this6.divsContainer.children[index].style.transform = 'scale(' + value.scale + ')';
      }).start();
