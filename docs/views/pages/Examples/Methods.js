...
const MethodsExample = () => {
  ...
  return (
    <div>
      <h2>Methods</h2>
      <p>
        The package supports three methods that can be used to control
        navigation. The "goBack()" method shows the previous slide while
        "goNext()" shows the next slide. The "goTo(index)" method goes to a
        particular index. It takes an integer as the parameter.
      </p>
