...
const CustomIndicatorExample = () => {
  ...
  return (
    <div>
      ...
      <p>
        The indicators shown below the slide can be customized to your design
        specification. It takes a boolean or a function. If it is set to true,
        it shows the default indicator style. If a function is passed then it
        displays the element returned in that function. The indicator for the
        current slide has an active class that can be used in styling it
      </p>
